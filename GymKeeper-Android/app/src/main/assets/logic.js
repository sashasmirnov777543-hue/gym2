...
const trainingMax=(w,r)=>{const capped=Math.min(+r,AMRAP_REPS_CAP);const e1rm=epley1RM(w,capped);return{e1rm,tm:roundToStep(e1rm*TM_FACTOR),cappedReps:capped,rawReps:+r}};
  ...
  return{STEP,TM_FACTOR,AMRAP_REPS_CAP,roundToStep,epley1RM,trainingMax,readiness,isMiniTaper,isBoardPress,isMyoEligible,isMyoAllowed,myoStop,recalcText,amrapFingerprint,doubleProgression,dedupeOps,pearson};
});
